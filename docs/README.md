...
This folder contains the Firebase-unified growth stack docs for `oria.me`.
...
- **Need to configure Firebase?** See `setup/`
- **Need endpoint payloads?** See `reference/`
- **Need release checklist?** See `operations/`
- **Need system-level context?** See `architecture/`
